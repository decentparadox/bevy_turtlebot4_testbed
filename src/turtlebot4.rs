    ...
    commands.spawn((
        ...
        .with_children(|commands| {
            ...
            let chassis = commands.spawn_empty()
                ...
                // Add observers for the new picking system
                .observe(crate::drag::on_drag_start)
                .observe(crate::drag::on_drag_end)
                .observe(crate::drag::on_drag)
                .observe(crate::drag::on_click)
                .observe(crate::drag::on_pointer_over)
                .observe(crate::drag::on_pointer_out)
                .id();
